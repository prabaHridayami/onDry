...
<head>
    ...
    <script src="<?php echo base_url()?>assets/js/running.js" type="text/javascript"></script>
...
<body data-spy="scroll" data-target=".navbar-collapse">
            ...
            <div class="nav-top clearfix">
                ...
                <div class="head_top_social pull-right">
                    <ul class="list-inline">
                        ...
                        <li class="top_socail">
                            <a href="https://www.facebook.com/Laundry-Online-382465492228437/?modal=admin_todo_tour">
						...
						?>
                            <li>
                                <a href="<?php echo base_url()?>/signupform">
                            ...
                            <li>
                                <a href="<?php echo base_url()?>/mydashbor/index">
                                    <span class="glyphicon glyphicon-user"></span>
                                    <?= $username?>
                                </a>
                            </li>
                            <li>
                                <button class="button-log" data-toggle="modal" data-target=".bs-example-modal-sm">
    ...
    <section id="home" class="home" style="background-image: url('assets/image/09.jpg'); width:1349px; height:750px; ">
        <div class="overlay">
            <p class="ml9" style="color : rgb(236, 240, 241); font-size : 100pt; margin:200px 0 0 5%;">
            ...
            <p class="ml9" style="color : #032f3e; font-size : 40pt; margin:-50px 0 0 5%;">
                <span class="text-wrapper">
                    <span class="letters">Byebye Cucian Numpuk</span>
                </span>
            </p>
        </div>
    </section>
    <section id="laundry" style="background-image: url('assets/image/07.jpg'); height:600px;">
        <div class="container">
            ...
            <a style="margin-top:0px; margin-bottom:100px;width:30%" href="<?php echo base_url()?>order" class="btn btn-primary">Order Here</a>
        </div>
        </div>
    </section>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <i class="fa fa-question-circle"></i> Are you sure you want to log-out?</div>
                <div class="modal-footer">
                    <form method="post" action="<?=base_url()?>Logins/logout">
                        <input name="logoutuser" type="hidden" value="<?=$username?>" />
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCFuysYvwzP87U4KqDVk423Ew8AYb7y920">
    </script>
