...
<body>
    <div style="background-image :url('assets/image/06.jpg'); margin:0px;">
        <div class="container">
        ...
        <div class="atas">
            ...
            <?php endif; ?>
            <div style="background-image :url('assets/image/06.jpg'); margin-left:-20px; width:1349px;">
                <div class="col-md-12"></div>
                <form method="post" action="<?php echo base_url()?>users/register" style="margin-left: 33%; ">
                    <?php if($responce = $this->session->flashdata('Successfully')):
                echo '<script type="text/javascript">';
                    echo 'BootstrapDialog.alert(<?php echo $responce;?>)'; echo '</script>'; ?>
                    <?php endif;?>
                    <br>
                    <br>
                    ...
                    <div class="input-group" style="margin-bottom: 10px">
                        ...
                        <span class="input-group-addon" onclick="myFunction('myInput')">
