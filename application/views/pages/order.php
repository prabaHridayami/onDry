				...
				<form method="post" action="<?php echo base_url()?>Mydashbor/orderProses">
					<div class="panel-body">
						...
						<div class="form-group">
							<div class="row">
								<div class="col-sm-3">
									<label class="control-label">Paket
										<span class="text-danger">*</span>
									</label>
								</div>
								<div class="col-sm-4">
									...
									if(isset($paket) && count($paket) > 0): foreach($paket as $row ):?>
											<option value="<?=$row['id_paket']." - ".$row['harga_paket'];?>">
												<?=$row['nama_paket']."( ".$row['durasi/hari']." jam) (Rp. ".number_format($row['harga_paket'],2,",",".").")";?>
											</option>
						...
						<div class="form-group">
							<div class="row">
								<div class="col-sm-3">
									<label class="control-label">Berdasarkan
										<span class="text-danger">*</span>
									</label>
								</div>
								<div class="col-sm-3">
									<label>Jenis Pakaian
										<input type='radio' id='jp' name='berdasarkan' required value='jp'>
									</label>
									<label>Berat Pakaian
										<input type='radio' id='bp' name='berdasarkan' required value='bp'>
									</label>
								</div>
							</div>
						</div>
						<div class="form-group" id='divbp'>
							<div class="row">
								<div class="col-sm-3">
									<label class="control-label">Berat Pakaian
										<span class="text-danger">*</span>
									</label>
								</div>
								<div class="col-sm-2">
						...
						<div class="form-group" id='divjp'>
							...
							<div class="row">
								<div class="col-sm-3">
									<label class="control-label">Jenis Pakaian
										<span class="text-danger">*</span>
									</label>
								</div>
								<div>
									<div class="col-sm-4" style="float: left;">
										...
										if(isset($jenis_pakaian) && count($jenis_pakaian) > 0): foreach($jenis_pakaian as $row ):?>
												<option value="<?=$row['id_jenis_pakaian']." - ".$row['harga'];?>">
													<?=$row['nama']."(Rp. ".number_format($row['harga'],2,",",".").")";?>
												</option>
												<?php endforeach; endif;  ?>
										</select>
									</div>
